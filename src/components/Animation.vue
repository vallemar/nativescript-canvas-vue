...
function frameCallback(nowDate) {
    ...
    const frameInfo: any = { timestamp: (nowDate - startDate + 0.5) }
...
<template>
    <Frame>
        ...
        <Label :text="y2Animated"></Label> -->
                ...
                <!--  <Label :text="m2"></Label> -->
                <Dom height="100%" width="100%" horizontalAlignment="center" background="white" @loaded="readyCanvas">
                    <Group>
                        <Path ref="pathRef" paintStyle="fill" strokeWidth="1" color="red">
                            <LinearGradient :start="vec(cx, cy)" :end="vec(cx + 1, cy + 1)"
